...
>(({ className, rootRef, ...props }, ref) => (
  <div data-slot="calendar" ref={rootRef || ref} className={cn(className)} {...props} />
))
...
const CalendarWeekNumber = React.forwardRef<HTMLTableCellElement, React.ComponentProps<'td'>>(
  ({ children, ...props }, ref) => (
    <td ref={ref} {...props}>
